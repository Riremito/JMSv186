        ...
        if (c.getPlayer().getParty() == null) {
            ...
            if (party != null) {
                if (action == 0x1B) { //accept
                    ...
                    final MapleCharacter cfrom = c.getOdinChannelServer().getPlayerStorage().getCharacterById(party.getLeader().getId());
                    if (cfrom != null) {
    ...
    public static final void PartyOperation(ClientPacket cp, final MapleClient c) {
        ...
        switch (operation) {
            ...
            case 4: // invite
                ...
                final MapleCharacter invited = c.getOdinChannelServer().getPlayerStorage().getCharacterByName(cp.DecodeStr());
                if (invited != null) {
