...
public class WZDirectoryEntry extends WZEntry implements IMapleDataDirectoryEntry {
    ...
    private List<IMapleDataEntity> files = new ArrayList<>();
    private Map<String, IMapleDataEntity> entries = new HashMap<>();
    ...
    public void addFile(IMapleDataEntity fileEntry) {
        files.add(fileEntry);
    ...
    @Override
    public IMapleDataEntity getEntry(String name) {
