 ...
 */
package odin.client.messages;

import odin.client.messages.commands.CommandObject;
import odin.client.messages.commands.CommandExecute;
import java.util.ArrayList;
import odin.client.MapleCharacter;
import odin.client.MapleClient;
import odin.client.messages.commands.AdminCommand;
...
public class CommandProcessor {
    ...
    public static boolean processCommand(MapleClient c, String line, CommandType type) {
        if (DebugCommand.checkCommand(c, line)) {
            return true;
        }
        // 通常クライアントのコマンドの処理
