...
public class MaplePacketLittleEndianWriter extends GenericLittleEndianWriter {
    ...
    public MaplePacketLittleEndianWriter() {
        ...
        DebugLogger.DebugLog("OLD_SERVER_PACKET");
        StackTraceElement[] ste = new Throwable().getStackTrace();
        if (1 < ste.length) {
            DebugLogger.DebugLog(ste[1].getFileName() + ":" + ste[1].getLineNumber());
            DebugLogger.DebugLog(ste[1].getClassName() + "." + ste[1].getMethodName());
