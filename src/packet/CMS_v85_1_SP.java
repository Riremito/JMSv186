...
public class CMS_v85_1_SP {
    ...
    public static void Set() {
        ...
        ServerPacket.Header.LP_CheckUserLimitResult.Set(0x0006);
        ServerPacket.Header.LP_WorldInformation.Set(0x0009);
        ServerPacket.Header.LP_SelectWorldResult.Set(0x000A);
        ServerPacket.Header.LP_SelectCharacterResult.Set(0x000B);
        ...
        ServerPacket.Header.LP_MigrateCommand.Set(0x0018);
