 ...
 * @author Riremito
 */
public class DQ_Trocklocations {

    public static final String DB_TABLE_NAME = "trocklocations";
    ...
    public static void deleteAndSaveAll(Connection con, int characterId, int[] rocks) throws SQLException {
