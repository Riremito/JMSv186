    ...
    private boolean load() {
        ...
        switch (this.type) {
            case SKIN: {
                ...
                for (MapleDataEntity dir : WzXML.CHARACTER.getRootDirectory().getFiles()) {
            ...
            case FACE: {
                ...
                for (MapleDataEntity dir : WzXML.CHARACTER.getSubDirectoryFiles("Face")) {
            ...
            case HAIR: {
                ...
                for (MapleDataEntity dir : WzXML.CHARACTER.getSubDirectoryFiles("Hair")) {
            ...
            case JOB: {
                ...
                for (MapleDataEntity dir : WzXML.SKILL.getRootDirectory().getFiles()) {
            ...
            case ITEM: {
                ...
                for (MapleDataDirectoryEntry dir : WzXML.CHARACTER.getRootDirectory().getSubDirectories()) {
                    switch (dir.getName()) {
                        case "Afterimage", "Face", "Hair" -> {
                            // ignore.
                        }
                        default -> {
                            for (MapleDataEntity file : dir.getFiles()) {
                ...
                for (MapleDataDirectoryEntry dir : WzXML.ITEM.getRootDirectory().getSubDirectories()) {
                    switch (dir.getName()) {
                        case "Cash", "Consume", "Etc", "Install" -> {
                            for (MapleDataEntity mde : dir.getFiles()) {
                                Matcher matcher_item_category_img = pattern_item_category_img.matcher(mde.getName());
                                if (matcher_item_category_img.matches()) {
                                    for (MapleData md : WzXML.ITEM.getData(dir.getName() + "/" + mde.getName()).getChildren()) {
            ...
            case MAP: {
                ...
                for (MapleDataDirectoryEntry dir : WzXML.MAP.getSubDirectory("Map").getSubDirectories()) {
            ...
            case MOB: {
                ...
                for (MapleDataEntity dir : WzXML.MOB.getRootDirectory().getFiles()) {
            ...
            case NPC: {
                ...
                for (MapleDataEntity dir : WzXML.NPC.getRootDirectory().getFiles()) {
            ...
            case REACTOR: {
                ...
                for (MapleDataEntity dir : WzXML.REACTOR.getRootDirectory().getFiles()) {
            ...
            case SKILL: {
                ...
                for (MapleDataEntity dir : WzXML.SKILL.getRootDirectory().getFiles()) {
                    Matcher matcher_job_img = pattern_job_img.matcher(dir.getName());
                    if (matcher_job_img.matches()) {
                        MapleData md_skill = WzXML.SKILL.getData(dir.getName()).getChildByPath("skill");
                        if (md_skill != null) {
                            for (MapleData md : md_skill.getChildren()) {
