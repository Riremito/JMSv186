 ...
 * @author Riremito
 */
public enum OpsSkill {
    // doriyan's code
    NOVICE_THROW_SNAIL(1000),
    NOVICE_REGENERATION(1001),
    NOVICE_MOVING_WITH_ACTIVITY(1002),
    ...
    NOVICE_VISITOR_OS3A_RIDING(1071),
    NOBLELESS_VISITOR_OS3A_RIDING(10001071),
    ARAN_VISITOR_OS3A_RIDING(20001071),
    EVAN_VISITOR_OS3A_RIDING(20011071),
    CITIZEN_VISITOR_OS3A_RIDING(30001071),
    ...
    KNIGHT_SHIELD_MASTERY(1210001),
    KNIGHT_CHARGE_BLOW(1211002),
    KNIGHT_FIRE_CHARGE(1211004),
    KNIGHT_ICE_CHARGE(1211006),
    KNIGHT_LIGHTNING_CHARGE(1211008),
    KNIGHT_MAGIC_CRASH(1211009),
    KNIGHT_RESTORATION(1211010),
    KNIGHT_COMBAT_ORDERS(1211011),
    ...
    public static OpsSkill find(int skill_id) {
        for (final OpsSkill o : OpsSkill.values()) {
            if (o.get() == skill_id) {
                return o;
            }
        }
