...
public enum OpsMiniRoomProtocol implements IPacketOps {
    ...
    public static void init() {
        ...
        if (Version.GreaterOrEqual(Region.JMS, 186) || Version.PostBB()) {
            ...
            MRP_Leave.set(10);
            MRP_Balloon.set(11);
            MRP_NotAvailableField.set(0);
            MRP_FreeMarketClip.set(0);
            MRP_CheckSSN2.set(0);
            TRP_PutItem.set(13);
            TRP_PutMoney.set(14);
            TRP_Trade.set(15);
            TRP_UnTrade.set(0);
            TRP_MoveItemToInventory.set(0);
            TRP_ItemCRC.set(0);
            TRP_LimitFail.set(0);
            PSP_PutItem.set(19);
            PSP_BuyItem.set(20);
            PSP_BuyResult.set(21);
            PSP_Refresh.set(22);
            PSP_AddSoldItem.set(23);
            PSP_MoveItemToInventory.set(24);
            PSP_Ban.set(25);
            PSP_KickedTimeOver.set(26);
            PSP_DeliverBlackList.set(27);
            PSP_AddBlackList.set(28);
            PSP_DeleteBlackList.set(29);
            ESP_PutItem.set(30);
            ESP_BuyItem.set(31);
            ESP_BuyResult.set(32);
            ESP_Refresh.set(33);
            ESP_AddSoldItem.set(34);
            ESP_MoveItemToInventory.set(35);
            ESP_GoOut.set(36);
            ESP_ArrangeItem.set(37);
            ESP_WithdrawAll.set(38);
            ESP_WithdrawAllResult.set(39);
            ESP_WithdrawMoney.set(40);
            ESP_WithdrawMoneyResult.set(41);
            ...
            MGRP_TieRequest.set(47);
            MGRP_TieResult.set(48);
            MGRP_GiveUpRequest.set(49);
            MGRP_GiveUpResult.set(50);
            MGRP_RetreatRequest.set(51);
            MGRP_RetreatResult.set(52);
