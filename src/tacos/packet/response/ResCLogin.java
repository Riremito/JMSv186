...
public class ResCLogin {
    ...
    public static ServerPacket WorldInformation(TacosWorld world) {
        ...
        if (Version.GreaterOrEqual(Region.KMS, 118) || Version.GreaterOrEqual(Region.KMST, 391) || Version.GreaterOrEqual(Region.JMS, 302) || Version.GreaterOrEqual(Region.JMST, 110) || Version.GreaterOrEqual(Region.EMS, 89) || Version.GreaterOrEqual(Region.TWMS, 148) || Version.GreaterOrEqual(Region.CMS, 104) || Version.GreaterOrEqual(Region.GMS, 111)) {
            sp.Encode4(0);
        }
        if (Version.GreaterOrEqual(Region.EMS, 89)) {
            sp.Encode4(0);
    ...
    public static ServerPacket SelectWorldResult(MapleClient client, OpsLogin result) {
        ...
        for (MapleCharacter chr : chars) {
            ...
            sp.EncodeBuffer(DataGW_CharacterStat.Encode(chr));
            sp.EncodeBuffer(DataAvatarLook.Encode(chr));
            if ((Region.JMS.check() || Region.JMST.check() || Region.KMS.check() || Region.KMST.check() || Region.IMS.check() || Region.EMS.check() || Region.THMS.check() || Region.MSEA.check()) && (Version.PostBB() || Version.GreaterOrEqual(Region.KMS, 92) || Version.GreaterOrEqual(Region.JMS, 180) || Version.GreaterOrEqual(Region.CMS, 85) || Version.GreaterOrEqual(Region.TWMS, 121) || Version.GreaterOrEqual(Region.THMS, 87) || Version.GreaterOrEqual(Region.GMS, 91) || Version.GreaterOrEqual(Region.MSEA, 100) || Version.GreaterOrEqual(Region.EMS, 70) || Version.GreaterOrEqual(Region.KMS, 84)) || Version.GreaterOrEqual(Region.GMS, 83)) {
                sp.Encode1(0); // family
            }
            sp.Encode1(1); // ranking
            sp.Encode4(chr.getRank()); // all world ranking
        ...
        if (Version.LessOrEqual(Region.EMS, 70)) {
            sp.Encode4(charslots); // m_nSlotCount
            sp.Encode4(0);
            sp.Encode8(0);
            return sp;
