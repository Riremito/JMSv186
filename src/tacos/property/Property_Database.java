...
public class Property_Database {
    ...
    public static boolean init() {
        ...
        if (url.isEmpty()) {
            ...
            url = "jdbc:mysql://" + database_host + ":" + database_port + "/" + Region.getName().toLowerCase() + "_v" + Version.getVersion() + "?createDatabaseIfNotExist=true&autoReconnect=true&characterEncoding=utf8&useSSL=false";
        }
