...
public class ClientPacket {
    ...
    public static void SetForJMSv188() {
        ...
        Header.CP_CreateNewCharacter.Set(0x000B);
        Header.CP_DeleteCharacter.Set(0x000D);
        Header.CP_ExceptionLog.Set(0x000F); // OK
        Header.CP_Check2ndPassword.Set(0x0012); // 2次パスワード、ログイン画面
        ...
        {
            Header.CP_UserTransferFieldRequest.Set(0x001A); // v188
            {
                ...
                Header.CP_UserMove.Set(Header.CP_UserTransferFieldRequest.Get() + 3);
                Header.CP_UserSitRequest.Set(Header.CP_UserTransferFieldRequest.Get() + 4);
                Header.CP_UserPortableChairSitRequest.Set(Header.CP_UserTransferFieldRequest.Get() + 5);
            }
            Header.CP_UserMeleeAttack.Set(0x0020); // v188
            {
                ...
                Header.CP_UserHit.Set(Header.CP_UserMeleeAttack.Get() + 4);
                Header.CP_UserAttackUser.Set(Header.CP_UserMeleeAttack.Get() + 5);
            }
            ...
            Header.CP_UserRemoteShopOpenRequest.Set(Header.CP_UserSelectNpc.Get() + 1);
            Header.CP_UserScriptMessageAnswer.Set(Header.CP_UserSelectNpc.Get() + 2);
            Header.CP_UserShopRequest.Set(Header.CP_UserSelectNpc.Get() + 3);
            Header.CP_UserTrunkRequest.Set(Header.CP_UserSelectNpc.Get() + 4);
            Header.CP_UserEntrustedShopRequest.Set(Header.CP_UserSelectNpc.Get() + 5);
