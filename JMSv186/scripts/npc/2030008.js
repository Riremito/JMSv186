	...
	if (selection == 0) { //ZPQ
		...
		if (next) {
			...
			if (prop.equals("false") || prop == null) {
			    ...
			    cm.sendOk("An another party has already started this quest. Please try again later.");
			}
		    }
		    cm.dispose();
		} else {
		...
		cm.dispose();
	    	...
	    	cm.sendYesNo("So, you wish to bribe me? Ha, I do not take them lightly. You will have to pay up #e500,000,000#n mesos for me to let you through!");
		status = 3;
	    }
	}
    } else if (status == 2) {
